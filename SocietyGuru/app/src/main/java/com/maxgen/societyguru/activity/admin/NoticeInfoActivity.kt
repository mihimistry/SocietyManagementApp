...
import com.maxgen.societyguru.adapter.admin.NoticeSentToListAdapter
import com.maxgen.societyguru.adapter.admin.OnNoticeSentToOptionClick
import com.maxgen.societyguru.databinding.ActivityNoticeInfoBinding
...
class NoticeInfoActivity : AppCompatActivity(), FireAccess.NoticeInfoListener,
    ...
    private var adapter: NoticeSentToListAdapter? = null
